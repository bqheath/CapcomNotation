...
public class Camera2BasicFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mAreaView = (AreaView) view.findViewById(R.id.area);
        mAreaView.setBackgroundColor(Color.TRANSPARENT);
    }
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    ...
                    mAreaView.setAspectRatio(
                            mPreviewSize.getWidth(), mPreviewSize.getHeight());
                } else {
                    mTextureView.setAspectRatio(
                            mPreviewSize.getHeight(), mPreviewSize.getWidth());

                    Log.d("PREVIEW RESOLUTION", "W: " + mPreviewSize.getHeight() + " H: " + mPreviewSize.getWidth());
    ...
    private void captureStillPicture() {
        try {
            ...
            cropRegion= new Rect(activeArray.width() / 2, activeArray.height() / 2, activeArray.width() / 2, activeArray.height() / 2);
            // Orientation
            int rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
